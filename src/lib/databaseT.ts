    ...
    public: {
        Tables: {
            conversations: {
                ...
                Relationships: [
                    {
                        foreignKeyName: "conversations_user_one_id_users_id_fk"
                        columns: ["user_one_id"]
                        isOneToOne: false
                    ...
                    {
                        foreignKeyName: "conversations_user_two_id_users_id_fk"
                        columns: ["user_two_id"]
                        isOneToOne: false
                        referencedRelation: "users"
                        referencedColumns: ["id"]
            ...
            reactions: {
                ...
                Relationships: [
                    {
                        foreignKeyName: "reactions_message_id_messages_id_fk"
                        columns: ["message_id"]
                        isOneToOne: false
                        referencedRelation: "messages"
                        referencedColumns: ["id"]
