...
export const MessageReactions = ({reactions}: MessageReactionProps) => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="z-30 flex group-[.current-user]:justify-start place-items-center justify-end w-full">
            ...
            <DropdownMenuContent side={"right"} className="min-w-xs">
