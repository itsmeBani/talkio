...
function Sidebar() {
    ...
    const ACTIVE_CLASSNAME = "p-4 w-full justify-center place-items-center   relative text-blue-500 after:bg-blue-500 after:h-1.5 after:rounded-full after:w-1.5 after:-bottom-0 after:left-1/2 after:-translate-x-1/2 after:absolute";
    const INACTIVE_CLASSNAME = " p-4 w-full dark:text-white justify-center place-items-center  text-gray-500";

    const SidebarStyle = ({ isActive } :{isActive:boolean}) =>
        isActive ? ACTIVE_CLASSNAME : INACTIVE_CLASSNAME;

    return (
        <div className="flex lg:w-20 shadow-md dark:bg-[#191919]  z-1 lg:flex-col place-items-center justify-between  lg:py-4 px-3 pb-5 pt-1 lg:p-2">
            <div>
